...
LICENSE="GPL-2"
SLOT="0"
IUSE="ae airplay alsa altivec avahi bluray css debug goom joystick libcec midi profile +projectm pulseaudio pvr +rsxs rtmp +samba sse sse2 udev vaapi vdpau webserver +xrandr"
