...
KEYWORDS="-* ~x86 ~amd64"
SRC_URI="x86?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.3.317/plexmediaserver_0.9.7.3.317-d4217ec_i386.deb )
	amd64?	( http://plex.r.worldssl.net/PlexMediaServer/0.9.7.3.317/plexmediaserver_0.9.7.3.317-d4217ec_amd64.deb )"
SLOT="0"
LICENSE="GPL-2"
IUSE=""
