...
# $Header: /var/cvsroot/gentoo-x86/net-misc/remmina/remmina-1.0.0_p20120309.ebuild,v 1.4 2012/05/05 03:20:42 jdhore Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-fix-rdp-cliprdr.patch"
}
