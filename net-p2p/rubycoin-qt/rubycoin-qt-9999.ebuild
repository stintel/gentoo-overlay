...
# $Header: /var/cvsroot/gentoo-x86/net-p2p/rubycoin-qt/rubycoin-qt-1.4.1.ebuild,v 1.1 2014/01/30 18:12:56 sdamashek Exp $
...
HOMEPAGE="https://rubycoin.com/"
case ${PV} in
9999)
	inherit git-2
	EGIT_REPO_URI="git://github.com/rubycoinorg/rubycoin.git"
	EGIT_BRANCH="master"
	;;
*)
...
src_prepare() {
	...
	epatch "${FILESDIR}/rubycoin-qt-bitcoingui-walletframe.patch"

	sed 's/BDB_INCLUDE_PATH=.*//' -i 'rubycoin-qt.pro'
...
#	qt4-r2_src_install
	...
	make_desktop_entry "${PN} %u" "RubyCoin-Qt" "/usr/share/pixmaps/${PN}.ico" "Qt;Network;P2P;Office;Finance;" "MimeType=x-scheme-handler/rubycoin;\nTerminal=false"
