...
# $Header: /var/cvsroot/gentoo-x86/net-wireless/wpa_supplicant/wpa_supplicant-0.7.1.ebuild,v 1.3 2010/04/03 12:27:49 gurligebis Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/wpa_supplicant-0.7.1-dbus_path_fix.patch
}
